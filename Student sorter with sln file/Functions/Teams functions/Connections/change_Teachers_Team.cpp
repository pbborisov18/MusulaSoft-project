...
void connectionsChangeTeacherTeam(string teachersEmail){ //Changes the number of teams the teacher is in
    ...
    while(getline(file,firstName,',')){ //While loop which is entered if there is text between the start of the row and first comma
        ...
        if(email != teachersEmail){ //We enter the if statement if the name of the teacher isn't what we want to edit
