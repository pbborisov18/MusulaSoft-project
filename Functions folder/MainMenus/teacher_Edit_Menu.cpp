...
void teachersEditMenu(string teacherToBeEdited){
    ...
    while(cin.fail() || chooserTeEdit < 1 || chooserTeEdit > 4){ //If user fails to enter a number mentioned in the menu or enters something not accepted by int type. Allows user to re-enter.
