...
void studentsEditMenu(string studentToBeEdited){
    ...
    while(cin.fail() || chooserStEdit < 1 || chooserStEdit > 6){ //If user fails to enter a number mentioned in the menu or enters something not accepted by int type. Allows user to re-enter.
